<nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
    <div class="navbar-header">
        ...
        <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
            ...
            <span class="navbar-brand-text">{{ Setting::get('site_title') }}</span>
        </div>
    </div>
                ...
                <i></i>
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li role="presentation">
                            <a href="{{ route('admin.profile') }}" role="menuitem"><i class="icon md-account" aria-hidden="true"></i> Profile</a>
                        </li>
                        <li role="presentation">
                            <a href="{{ route('admin.settings') }}" role="menuitem"><i class="icon md-settings" aria-hidden="true"></i> Settings</a>
                        </li>
