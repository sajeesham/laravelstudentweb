...
@section('content')
    <div class="page animsition">
        ...
        <div class="page-content">
            <!-- Panel Form Elements -->
            <form method="post" action="{{ route('admin.student.store') }}" id="department_create_form" enctype="multipart/form-data">
                @csrf
                <div class="panel">
                            ...
                            <div class="col-sm-6 col-md-6 padding-left-0">
                                <div class="form-group">
                                    <div class="example-wrap @error('name') has-error @enderror">
                                        <h4 class="example-title">Student Name<span class="required">*</span></h4>
                                        <input type="text" class="form-control" name="name" id="name" placeholder="Student Name" value="{{ old('name') }}">
                                        @error('name')
